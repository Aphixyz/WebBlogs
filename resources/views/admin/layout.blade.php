            ...
            <div id="sidebar">
                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        <!-- Brand -->
                        <a href="{{ route('admin.active') }}" class="sidebar-brand">
                        ...
                        <ul class="sidebar-nav">
                            <li>
                                <a href="{{ route('admin.active') }}" class=" active"><i
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ route('admin.getfromblog'), }}">เขียนบทความ</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{ route('admin.active') }}">ดูจำนวนบทความ</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
            ...
            <div id="main-container">
                ...
                <div id="page-content">
                    ...
                    {{-- <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <!-- Widget -->
                            <a href="{{ route('admin.active') }}" class="widget widget-hover-effect1">
                                <div class="widget-simple">
