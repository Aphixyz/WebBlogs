            ...
            <div class="container-fluid">
                <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                    ...
                    <a class="navbar-brand" href="tech-index.html"><img
                            src="static/frontend/images/version/tech-logo.png " alt=""></a>
                ...
                <div class="masonry-blog clearfix">
                    <div class="first-slot">
                        <div class="masonry-box post-media">
                            <img src="static/frontend/upload/tech_01.jpg " alt="" class="img-fluid">
                            <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-orange"><a href="tech-category-01.html"
                                                title="">เทคโนโลยี</a></span>
                                        <h4><a href="#" title="">Say hello to real handmade office
                                                furniture! Clean &
                    ...
                    <div class="second-slot">
                        <div class="masonry-box post-media">
                            <img src="static/frontend/upload/tech_02.jpg " alt="" class="img-fluid">
                            <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-orange"><a href="tech-category-01.html"
                                                title="">ท่องเที่ยว</a></span>
                                        <h4><a href="#" title="">Do not make mistakes when choosing web
                                                hosting</a></h4>
                    ...
                    <div class="last-slot">
                        <div class="masonry-box post-media">
                            <img src="static/frontend/upload/tech_03.jpg " alt="" class="img-fluid">
                            <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-orange"><a href="tech-category-01.html"
                                                title="">เทคโนโลยี</a></span>
                                        <h4><a href="#" title="">The most reliable Galaxy Note 8 images
                                                leaked</a></h4>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            <div class="blog-top clearfix">
                                <h4 class="pull-left">บทความล่าสุด <a href="#"><i class="fa fa-rss"></i></a>
                                </h4>
                            </div><!-- end blog-top -->
                            ...
                            <div class="blog-list clearfix">
                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="#" title="">
                                                <img src="static/frontend/upload/tech_01.jpg " alt=""
                                                    class="img-fluid">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <h4><a href="#" title="">Top 10 phone applications and 2017 mobile
                                                design
                                                awards</a></h4>
                                ...
                                <div class="blog-box row">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <h4><a href="#" title="">A device you can use both headphones and
                                                usb</a></h4>
                                        <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et
                                            pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enim
                                            nibh, maximus ac felis nec, maximus tempor odio.</p>
                                        <small class="firstsmall"><a class="bg-orange" href="tech-category-01.html"
                                                title="">เทคโนโลยี</a></small>
                                        <small><a href="#" title="">21 July, 2017</a></small>
                                        <small><a href="tech-author.html" title="">by Matilda</a></small>
                                        <small><a href="#" title=""><i class="fa fa-eye"></i>
                                                4412</a></small>
                                ...
                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="#" title="">
                                                <img src="static/frontend/upload/tech_blog_03.jpg" alt=""
                                                    class="img-fluid">
                                                <div class="hovereffect"></div>
                                            </a>
                                        </div><!-- end media -->
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <h4><a href="#" title="">Two brand new laptop models from ABC
                                                computer</a></h4>
                                        <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et
                                            pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enim
                                            nibh, maximus ac felis nec, maximus tempor odio.</p>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                        <div class="sidebar">
                            <div class="widget">
                                <h2 class="widget-title">บทความทั้งหมด</h2>
                                <div class="trend-videos">
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="#" title="">
                                                <img src="static/frontend/upload/tech_video_01.jpg" alt=""
                                                    class="img-fluid">
                                        ...
                                        <div class="blog-meta">
                                            <h4><a href="#" title="">We prepared the best 10 laptop
                                                    presentations for
                                                    you</a></h4>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                    ...
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="#" title="">
                                                <img src="static/frontend/upload/tech_video_02.jpg" alt=""
                                                    class="img-fluid">
                                                <div class="hovereffect">
                                                    <span class="videohover"></span>
                                                </div><!-- end hover -->
                                        ...
                                        <div class="blog-meta">
                                            <h4><a href="#" title="">We are guests of ABC Design Studio -
                                                    Vlog</a></h4>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                    ...
                                    <div class="blog-box">
                                        <div class="post-media">
                                            <a href="#" title="">
                                                <img src="static/frontend/upload/tech_video_03.jpg" alt=""
                                                    class="img-fluid">
                                                <div class="hovereffect">
                                                    <span class="videohover"></span>
                                                </div><!-- end hover -->
                                        ...
                                        <div class="blog-meta">
                                            <h4><a href="#" title="">Both blood pressure monitor and
                                                    intelligent
                                                    clock</a></h4>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                    ...
                                    <div class="list-group">
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="w-100 last-item justify-content-between">
                                                <!-- <img src="frontend/images/version/tech-footer-logo.png " alt=""class="img-fluid float-left"> -->
                                                <img src="static/frontend/upload/tech_blog_03.jpg" alt=""
                                                    class="img-fluid float-left">
